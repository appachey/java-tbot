...
import com.github.jrtb.dto.GroupStatDTO;
...
import static com.github.jrtb.command.AbstractCommandTest.prepareUpdate;
import static com.github.jrtb.command.StatCommand.STAT_MESSAGE;
   ...
   @Test
    public void shouldProperlySendMessage() {
       ...
       Mockito.verify(sendBotMessageService).sendMessage(chatId, format(STAT_MESSAGE,
               ...
               format("%s (id = %s) - %s подписчиков", groupDto.getTitle(), groupDto.getId(),
